...
impl HTMLLinkElement {
    ...
    fn processing_options(&self) -> LinkProcessingOptions {
        ...
        // Empty link elements are permitted in live documents while authors or
        // frameworks are still populating their attributes. The later request
        // construction path treats an empty href/source set as having no
        // fetchable resource; do not abort the script thread on this transient
        // DOM state.
