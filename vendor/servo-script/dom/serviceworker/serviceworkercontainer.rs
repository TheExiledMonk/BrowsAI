...
impl ServiceWorkerContainerMethods<crate::DomTypeHolder> for ServiceWorkerContainer {
    ...
    ///
    /// Message delivery is already enabled by the container's native message
    /// routing in this implementation. Expose the standard idempotent entry
    /// point so feature detection and service-worker libraries do not fail
