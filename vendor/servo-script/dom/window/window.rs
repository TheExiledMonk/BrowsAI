...
pub(crate) struct Window {
    ...
    /// The manager that supplied the user scripts. Child browsing contexts
    /// inherit this identity so compatibility hooks also run in iframes.
    #[no_trace]
    #[ignore_malloc_size_of = "UserContentManagerId"]
...
impl Window {
    ...
    pub(crate) fn user_content_manager_id(&self) -> Option<UserContentManagerId> {
        self.user_content_manager_id
    }
